...
public class ApiReqMemberSetOssConditionRequest
{
	...
	public string ApiLanguageType { get; set; }

	[JsonPropertyName("api_oss_items[0]")]
	public string ApiOssItems0 { get; set; }

	[JsonPropertyName("api_oss_items[1]")]
	public string ApiOssItems1 { get; set; }

	[JsonPropertyName("api_oss_items[2]")]
	public string ApiOssItems2 { get; set; }

	[JsonPropertyName("api_oss_items[3]")]
	public string ApiOssItems3 { get; set; }

	[JsonPropertyName("api_oss_items[4]")]
	public string ApiOssItems4 { get; set; }

	[JsonPropertyName("api_oss_items[5]")]
	public string ApiOssItems5 { get; set; }

	[JsonPropertyName("api_oss_items[6]")]
	public string ApiOssItems6 { get; set; }

	[JsonPropertyName("api_oss_items[7]")]
	public string ApiOssItems7 { get; set; }
}
