...
getMember.MapPost("/questlist", (ApiGetMemberQuestlistRequest _) => new ApiGetMemberQuestlistResponse()); // todo
getMember.MapPost("/record", (ApiGetMemberRecordRequest _) => new ApiResponse<ApiGetMemberRecordResponse>());
getMember.MapPost("/require_info", (ApiGetMemberRequireInfoRequest _) => new ApiGetMemberRequireInfoResponse()); // todo
getMember.MapPost("/ship2", (ApiGetMemberShip2Request _) => { /* todo */ }); // todo
getMember.MapPost("/ship3", (ApiGetMemberShip3Request _) => new ApiGetMemberShip3Response()); // todo
getMember.MapPost("/ship_deck", (ApiGetMemberShipDeckRequest _) => new ApiResponse<ApiGetMemberShipDeckResponse>());
getMember.MapPost("/slot_item", (ApiGetMemberSlotItemRequest _) => new ApiGetMemberSlotItemResponse()); // todo
...
getMember.MapPost("/unsetslot", (ApiGetMemberUnsetslotRequest _) => new ApiGetMemberUnsetslotResponse()); // todo
