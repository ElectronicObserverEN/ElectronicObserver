...
public class FormMainTranslationViewModel : TranslationBaseViewModel
{
	...
	public string StripMenu_Update_UpdateAvailable => Properties.Window.FormMain.Update_UpdateAvailable.Replace("_", "__").Replace("&", "_");
	public string StripMenu_Update_DownloadUpdate => Properties.Window.FormMain.Update_DownloadUpdate.Replace("_", "__").Replace("&", "_");
	public string StripMenu_Update_OpenReleaseNotes => Properties.Window.FormMain.Update_OpenReleaseNotes.Replace("_", "__").Replace("&", "_");
